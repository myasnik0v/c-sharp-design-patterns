...
## Применимость
1. нужно расширить поведение без изменения существующих объектов
2. нужен способ комбинировать поведение объектов, который не приведет в большому количеству новых классов на верхних уровнях иерархии
